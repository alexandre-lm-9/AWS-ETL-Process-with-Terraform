...
rais = (
    spark.read
    .csv("s3://datalake-alexandre-tf-desafio-1-edc/raw-data/", inferSchema=True, header=True, sep=';', encoding="latin1")
)
...
# Creating "uf" and "ano" columns and filling them
...
(
    ...
    .partitionBy('ano', 'uf')
    .format('parquet')
    .save("s3://datalake-alexandre-tf-desafio-1-edc/tf-staging/rais-processed-2020-tf")
)
